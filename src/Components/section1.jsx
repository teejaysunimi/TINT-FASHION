    ...
    <div className="bg-black block text-center pt-4 text-white">
      ...
      <div className="flex justify-center items-start p-4 gap-5">
        <div className="object-cover">
          <img className="w-96 " src={odn} alt="odn" />
        </div>
        <div className="object-cover relative inline-block">
          <img className="w-96 " src={rrr} alt="rrr" />
        ...
        <div className="object-cover ">
          <img className="w-96" src={OOM} alt="OOOM" />
        </div>
      </div>
    </div>
  );
